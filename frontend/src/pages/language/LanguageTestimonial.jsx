...
const LanguageTestimonial = () => {
  ...
  return (
    <div className="relative bg-[#F5F5DC] pt-36">
      {/* Top Curve */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#C23925]">
            Testimonials
          </h2>
          ...
          {[...Array(8)].map((_, i) => (
            <button
              ...
              className={`w-2 h-2 rounded-full ${
                i === 0 ? "bg-[#4B4B4B]" : "bg-[rgba(0,0,0,0.2)]"
              }`}
...
export default LanguageTestimonial;
